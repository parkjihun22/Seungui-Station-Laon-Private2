...
const ComplexGuide1 = () => {
  ...
  return (
    <div className={styles.container}>
        <Helmet>
          <title>숭의역 라온프라이빗 - 청약방법 안내</title>
          <meta
            name="description"
            content="숭의역 라온프라이빗 청약방법을 확인하세요. 청약 자격, 신청 절차, 준비서류 및 유의사항을 상세히 안내합니다."
          />
          <link rel="canonical" href="https://locamobility.co.kr/SalesInfo/SubscriptionGuide" />
      ...
      <p className={styles.screenReaderOnly}>
        숭의역 라온프라이빗 분양 전 필수 체크포인트를 확인하세요. 청약
