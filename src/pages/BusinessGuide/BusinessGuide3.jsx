...
const BusinessGuide2 = () => {
	...
	return (
		<div className={styles.container}>
			<Helmet>
				{/* 필수 메타 */}
				<title>숭의역 라온프라이빗 - 계약서류안내</title>
				<meta
					name="description"
					content="인천 숭의역 라온프라이빗 분양 계약을 위한 서류 안내. 신분증, 주민등록등본, 인감증명서 등 필수 제출서류와 준비 절차, 유의사항을 빠르고 정확하게 확인하세요."
				/>
				...
				<meta property="og:title" content="숭의역 라온프라이빗 - 계약서류안내" />
				<meta
					property="og:description"
					content="숭의역 라온프라이빗 계약서류 안내: 신분증, 주민등록등본, 인감증명서 등 필수 제출서류와 준비 절차, 유의사항을 확인하세요."
				/>
				<meta property="og:url" content="https://locamobility.co.kr/BusinessGuide/documents" />
			...
			<h1 className={styles.screenReaderOnly}>숭의역 라온프라이빗 - 계약서류안내</h1>
			<p className={styles.screenReaderOnly}>
				계약서류안내 페이지에서는 분양 당첨 후 필요한 서류들을 안내합니다. 
				계약 체결을 위해 반드시 준비해야 할 서류 목록과 함께 제출 기한, 발급 방법, 유의사항까지 
				상세히 알려드려 고객분들이 혼동 없이 준비할 수 있도록 돕습니다.
			</p>
			...
			{/* <img className={`${styles.image4} ${isImageVisible ? styles.visible : ''}`} src={page1} alt="숭의역 라온프라이빗 계약서류안내-image1" /> */}
